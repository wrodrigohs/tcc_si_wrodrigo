...
def get_data(dados):
    if (dados == 'Estadual - 1º turno'):
        df = pd.read_csv('Dashboad/data/df_estados_1turno_2020.csv')
    elif (dados == 'Estadual - 2º turno'):
        df = pd.read_csv('Dashboad/data/df_estados_2turno_2020.csv')
    elif (dados == 'Municipal - 1º turno'):
        df = pd.read_csv('Dashboad/data/df_municipios_1turno_2020.csv')
    else:
        df = pd.read_csv('Dashboad/data/df_municipios_2turno_2020.csv')
    return df
...
if ((dados == 'Estadual - 1º turno')
    ...
    with Q1:
        ...
        if (dados == 'Estadual - 1º turno'):
            htmlFile = open(
                    "Dashboad/data/charts/estados_1turno/mapa_estados_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, width=620, height=460)
        else:
            htmlFile = open(
                    "Dashboad/data/charts/estados_2turno/mapa_estados_2turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, width=620, height=460)
    ...
    if (dados == 'Municipal - 1º turno'):
        ...
        with Q1:
            htmlFile = open(
                "Dashboad/data/charts/municipios_1turno/mapa1_municipios_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)

        with Q2:
            htmlFile = open(
                "Dashboad/data/charts/municipios_1turno/mapa2_municipios_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)

        with Q3:
            htmlFile = open(
                "Dashboad/data/charts/municipios_1turno/mapa3_municipios_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)
        ...
        with Q4:
            htmlFile = open(
                "Dashboad/data/charts/municipios_2turno/mapa_municipios_2turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)

    ...
    with Q81:
        def plot_chart(estadoIndex, df):
            ...
            fig_combined.add_trace(go.Bar(
                ...
                x=df_estado[['solteiro_masculino', 'casado_masculino', 'divorciado_masculino', 'viúvo_masculino', 'separado_judicialmente_masculino',
                            'solteiro_feminino', 'casado_feminino', 'divorciado_feminino', 'viúvo_feminino', 'separado_judicialmente_feminino']].iloc[0],
                orientation='h',
                hoverinfo='x+text',

...
if ((dados == 'Estadual - 1º turno')
    ...
    with Q81:
        def plot_chart(estadoIndex, df):
            ...
            data = {
                'estado': [estado],
                'solteiro_masculino': [100],
                'casado_masculino': [200],
                'divorciado_masculino': [30],
                'viuvo_masculino': [10],
                'separado_judicialmente_masculino': [5],
                'solteiro_feminino': [90],
                'casado_feminino': [180],
                'divorciado_feminino': [25],
                'viuvo_feminino': [8],
                'separado_judicialmente_feminino': [4],
                }

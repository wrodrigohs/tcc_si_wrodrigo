...
if ((dados == 'Estadual - 1º turno')
    ...
    with Q80:
        ...
        homens_solteiro = df['solteiro_masculino']
        ...
        fig.add_trace(go.Bar(y=estados,
                             x=mulheres_solteiro,
                             customdata=mulheres_solteiro.astype('int'),
                             hovertemplate='%{y} %{customdata}',
                             marker_color='#FCC202',
                             name='Mulheres',
                             orientation='h'))

        fig.add_trace(go.Bar(y=estados, x=homens_solteiro*-1,
                             name='Homens',
                             customdata=homens_solteiro.astype('int'),
                             hovertemplate='%{y} %{customdata}',
                             marker_color='#355070',
                             orientation='h'))

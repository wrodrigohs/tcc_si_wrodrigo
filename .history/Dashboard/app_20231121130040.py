...
if ((dados == 'Estadual - 1º turno')
    ...
    with Q81:
        def plot_chart(estadoIndex, df):
            ...
            homens_casado = df['casado_masculino']
            ...
            mulheres_solteiro = df['solteiro_feminino']
            mulheres_casado = df['casado_feminino']

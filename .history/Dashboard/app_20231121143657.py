    ...
    with Q81:
        def plot_chart(estadoIndex, df):
            ...
            fig.add_trace(go.Bar(
                y=['Divorciado', 'Separado judicialmente', 'Solteiro', 'Casado', 'Viúvo'],
                x=df_estado[['divorciado_masculino', 'separado_judicialmente_masculino', 'solteiro_masculino', 'casado_masculino', 'viuvo_masculino']].iloc[0],
                orientation='h',
                name='Homens',
                # customdata=homens.astype('int'),
                # hovertemplate='%{y} %{customdata}',
            ...
            fig.add_trace(go.Bar(
                y=['Divorciado', 'Separado judicialmente', 'Solteiro', 'Casado', 'Viúvo'],
                x=df_estado[['divorciado_feminino', 'separado_judicialmente_feminino', 'solteiro_feminino', 'casado_feminino', 'viuvo_feminino',]].iloc[0],
                orientation='h',
                name='Mulheres',
                hoverinfo='x+text',

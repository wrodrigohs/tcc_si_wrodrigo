        ...
        def plot_chart(estadoIndex, df):
            ...
            for index, row in df.iterrows():
                fig_combined.add_trace(go.Bar(
                    ...
                    x=row[['solteiro_masculino', 'casado_masculino', 'divorciado_masculino', 'viúvo_masculino', 'separado_judicialmente_masculino',
                        'solteiro_feminino', 'casado_feminino', 'divorciado_feminino', 'viúvo_feminino', 'separado_judicialmente_feminino']],
                    orientation='h',
                    name=row['estado'],

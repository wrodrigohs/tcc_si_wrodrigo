        ...
        def plot_chart(estadoIndex, df):
            ...
            for index, row in df.iterrows():
                fig_combined.add_trace(go.Bar(
                    ...
                    orientation='h',
                    name=row['estado'] + ' - Homens',
                    text=['Solteiro', 'Casado', 'Divorciado', 'Viúvo', 'Separado Judicialmente'],
                    hoverinfo='x+text',
            ...
            for index, row in df.iterrows():
                fig_combined.add_trace(go.Bar(
                    y=[row['estado']],
                    x=row[['solteiro_feminino', 'casado_feminino', 'divorciado_feminino', 'viúvo_feminino', 'separado_judicialmente_feminino']],
                    orientation='h',
                    name=row['estado'] + ' - Mulheres',
                    text=['Solteira', 'Casada', 'Divorciada', 'Viúva', 'Separada Judicialmente'],
                    hoverinfo='x+text',

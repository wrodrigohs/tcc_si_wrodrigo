...
if ((dados == 'Estadual - 1º turno')
    ...
    with st.empty():
        if (dados == 'Estadual - 1º turno' or dados == 'Estadual - 2º turno'):
            ...
            escolaridade_percentual = df[['municipio', 'analfabeto_percentual(%)', 'le_escreve_percentual(%)',
            'fundamental_incompleto_percentual(%)', 'fundamental_completo_percentual(%)', 'medio_incompleto_percentual(%)',
            'medio_completo_percentual(%)', 
            'superior_incompleto_percentual(%)', 'superior_completo_percentual(%)']].sort_values(by = 'superior_completo_percentual(%)', ascending = False)[:10]
            x1 = escolaridade_percentual['municipio'] 
        ...
        my_layout = Layout(title='Divisão percentual da escolaridade nos municípios', hoverlabel = dict(

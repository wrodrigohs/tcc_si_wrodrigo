...
if ((dados == 'Estadual - 1º turno')
    ...
    with st.empty():
        if (dados == 'Estadual - 1º turno'):
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\estados_1turno\\estadosEscolaridade_1turno.html", 'r', encoding='utf-8')
        elif (dados == 'Estadual - 2º turno'):
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\estados_2turno\\estadosEscolaridade_2turno.html", 'r', encoding='utf-8')
        elif (dados == 'Municipal - 1º turno'):
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\municipios_1turno\\municipiosEscolaridade_1turno.html", 'r', encoding='utf-8')
        else:
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\municipios_2turno\\municipiosEscolaridade_2turno.html", 'r', encoding='utf-8')
    ...
    with Q4:
        ...
        fig_percentual_analfabetos = go.Figure(data=[
            go.Bar(name='', x=x1, y=analfabeto, hovertemplate=[f"{percent:.2f}%" for percent in x1],
                   text=[f"{percent:.2f}%" for percent in x1], textposition='outside', marker_color=colors, showlegend=False,
    ...
    if (dados == 'Municipal - 1º turno'):
        ...
        with Q1:
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\municipios_1turno\\mapa1_municipios_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)

        with Q2:
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\municipios_1turno\\mapa2_municipios_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)

        with Q3:
            htmlFile = open(
                "D:\\UFMS\\TCC\\Plotly Sample Dashboard\\Plotly Sample Dashboard\\assets\\charts\\municipios_1turno\\mapa3_municipios_1turno.html", 'r', encoding='utf-8')
            source_code = htmlFile.read()
            components.html(source_code, height=480)
    else:
        with st.empty():
